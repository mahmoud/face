...
class FlagDisplay(object):
    """Encapsulates all of a given flag's display settings, as used by
    HelpFormatter instances attached to Parser and Command
    objects. Pass an instance of this to Flag.set_display() for full
    control of help output.
    ...
    Args:
       ...
       name (str): The canonical name of the flag, i.e., the string
         used as an identifier in the ParseResult.

       label (str): The formatted version of the string used to
         represent the flag in help and error messages. Generally
         autogenerated.
